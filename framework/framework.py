...
for i in xrange(10,21):
	...
	dd2 = dataDispenser(datetime.datetime(9,1,1), datetime.timedelta(10), i)
	dd2.dispenseData(greedymodel)
	greedyTimes.append(dd2.averageResponseTime)
print greedyTimes

plt.plot(truckVec, greedyTimes, truckVec, oracleTimes)
plt.show()
